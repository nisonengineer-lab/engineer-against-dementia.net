/* ==========================================================================
   ...
   Сервер: care_api (Flask, аддон Home Assistant, порт 8092), читает
   care_diary.db. Адрес задаётся в <head>:
       <meta name="api-base" content="https://api.engineeragainstdementia.net">
   Для проверки против коробки в локальной сети адрес можно подменить прямо
   в ссылке:  /journal/?api=http://10.0.0.6:8092
